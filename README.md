...
- Avoid trying to improve internal DN's TV modules. They have uncertain license status and thus for sure will be removed in future. Instead, if you want to have UTF-8 in DN, for example, try to add it to Fire Vision, which is planned to be integrated as a replacement. You can use this project as reference on switching TV to UTF8: github.com/magiblot/tvision
