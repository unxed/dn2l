...
10. You will need to run `pe2elf` from `dn2l_tryouts/vp` on `dn2l_tryouts/dn2l/out.lnx/dn.exe` to get executable ELF file for linux
11. Don't forget to do `chmod +x` on `dn` file generated by pe2elf
